...
void CD4051_Init(void)
{
	GPIO_InitTypeDef GPIO_InitStructure;
 	...
 	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOC|RCC_APB2Periph_GPIOD|RCC_APB2Periph_GPIOE|RCC_APB2Periph_GPIOF|RCC_APB2Periph_GPIOG|RCC_APB2Periph_AFIO,ENABLE);//使能PORTA,PORTC时钟
	...
	GPIO_Init(GPIOF, &GPIO_InitStructure);//初始化GPIOC5
	GPIO_SetBits(GPIOF,GPIO_Pin_All);
	
	GPIO_Init(GPIOG, &GPIO_InitStructure);//初始化GPIOC5
